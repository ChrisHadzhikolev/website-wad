    ...
    <div class="mainn">
        ...
        <div class="row">
            <div class="column web">
                <div class="content">
                    <img src="{{asset('images/jaki-site.png')}}" alt="Jacquline">
            ...
            <div class="column web">
                <div class="content">
                    <img src="{{asset('images/kris-site.png')}}" alt="Kris">
            ...
            <div class="column web">
                <div class="content">
                    <img src="{{asset('images/WEBdev.png')}}" alt="Web">
            ...
            <div class="column oop">
                <div class="content">
                    <img src="{{asset('images/jaki-pizza.png')}}" alt="Software">
                    <h4>Pizza app</h4>
                    <p>Option 1</p>
                </div>
            </div>
            <div class="column oop">
                <div class="content">
                    <img src="{{asset('images/kris-pizza.png')}}"  alt="Software">
                    <h4>Pizza app</h4>
                    <p>Option 2</p>
                </div>
            </div>
            ...
            <div class="column oop">
                <div class="content">
                    <img src="{{asset('images/pizza-1.png')}}" alt="Software">
            ...
            <div class="column oop">
                <div class="content">
                    <img src="{{asset('images/building-app.jpg')}}" alt="Software">
            ...
            <div class="column combined">
                <div class="content">
                    <img src="{{asset('images/building-app.jpg')}}" alt="Combined">
                    <h4>Media Bazaar</h4>
                    <p>Mutual project</p>
                </div>
            </div>
