<div class="navigation" id="nav">
    <a class="title" href="index"><span>TelepathyBean</span></a>
    ...
    <?php else: ?>
    <a href="login" class="login_reg">Login</a>
    <?php endif; ?>

    <?php if( isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]): ?>
    <a href="MyProfilePage" class="login_reg">My Profile</a>
    <a href="UsersPage.php" class="login_reg">Users</a>
    <?php else: ?>
    <a href="register" class="login_reg">Registration</a>
    <?php endif; ?>
