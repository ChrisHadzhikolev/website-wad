...
<head>
    ...
    <title>{{ config('app.name', 'TelepathyBean') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                            <a class="nav-link" href="{{ action('ProjectsController@index') }}">{{ __('Projects') }}</a>
                            <a class="nav-link" href="{{ action('ContactController@index') }}">{{ __('ContactUs') }}</a>
                            <a class="nav-link" href="{{ action('AboutController@index') }}">{{ __('AboutUs') }}</a>
                    </ul>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ action('MyProfileController@index') }}">{{ __('My Profile') }}</a>
