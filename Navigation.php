...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2f292f;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
        <span><a class="nav-link"href="index.php">TelepathyBean</a></span></li>
      <li class="nav-item">
      ...
      <?php if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]): ?>
            ...
            <?php if( isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]): ?>
                <li class="nav-item"><a class="nav-link" href="php/MyProfilePage.php">My Profile</a></li>
            <?php else: ?>
                <li class="nav-item"><a class="nav-link" href="php/RegistrationPage.php">Registration</a></li>
            <?php endif; ?>    
